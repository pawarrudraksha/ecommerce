<?php
  ...
  if(isset($_POST["insert_product"])){
    ...
    // checking
    if($product_title=='' or $product_description=='' or $product_keywords=='' or $category_id=='' or $brand_id=='' or $product_price=='' or $product_image1=='' or $product_image3=='' or $product_image2==''){
    ...
    <div class="container mt-3">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_keywords" id="product_keyword" class="form-control" placeholder="Enter Product Keywords" autocomplete="off" required>
            </div>
            <!-- Categories -->
            <div class="form-outline mb-4 w-50 m-auto">
