...
<html lang="en">
  <head>
    ...
    <title>ECommmerce-Profile</title>
    <link
        ...
        <div class="col-md-2 p-0">
            <ul class="navbar-nav bg-secondary text-center">
                ...
                <?php
                        ...
                        $user_query="SELECT * FROM `user_table` WHERE `user_name` LIKE '$username'";
                        $result_query=mysqli_query($conn,$user_query);
                        $data=mysqli_fetch_assoc($result_query);
                        $image=$data["user_image"];
                    ?>
                    <img src="./user_images/<?php echo $image?>" height="90%" width="100%" alt="">
                </li>
